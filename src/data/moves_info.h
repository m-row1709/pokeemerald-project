...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_RETURN] =
    {
        ...
        .description = COMPOUND_STRING(
            "A powerful 102 base power\n"
            "attack, like Frustration."),
        .effect = EFFECT_HIT,
        .power = 102,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_ERUPTION] =
    {
        ...
        .description = COMPOUND_STRING(
            "A destructive Fire type\n"
            "attack that hurts the user."),
        .effect = EFFECT_HIT,
        .power = 150,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_GLACIATE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Blows cold air at the foe.\n"
            "It sharply lowers Speed."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_ICE,
        .accuracy = 100,
