...
static const struct TrainerMon sParty_Rose1[] = {
    ...
    .nature = NATURE_JOLLY,
    .moves = {MOVE_HEADBUTT, MOVE_DOUBLE_KICK, MOVE_BOUNCE, MOVE_FAKE_OUT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 12,
    ...
    .ability = ABILITY_CHLOROPHYLL,
    .nature = NATURE_QUIET,
    .moves = {MOVE_MEGA_DRAIN, MOVE_SIGNAL_BEAM, MOVE_STUN_SPORE, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 12,
    ...
    .nature = NATURE_MODEST,
    .moves = {MOVE_POWDER_SNOW, MOVE_CONFUSION, MOVE_SWIFT, MOVE_SWEET_KISS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 12,
    ...
    .moves = {MOVE_HEADBUTT, MOVE_RAZOR_LEAF, MOVE_FEINT_ATTACK, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Shawn[] = {
    ...
    .nature = NATURE_BRAVE,
    .moves = {MOVE_SLUDGE, MOVE_TWINEEDLE, MOVE_AERIAL_ACE, MOVE_BITE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 14,
    ...
    .nature = NATURE_NAIVE,
    .moves = {MOVE_SMOG, MOVE_FLAME_WHEEL, MOVE_PURSUIT, MOVE_ROAR}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 15,
    ...
    .nature = NATURE_TIMID,
    .moves = {MOVE_MAGICAL_LEAF, MOVE_TOXIC, MOVE_LEECH_SEED, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 13,
    ...
    .nature = NATURE_LAX,
    .moves = {MOVE_MUD_SLAP, MOVE_AERIAL_ACE, MOVE_TOXIC, MOVE_PROTECT}
    }
};
...
static const struct TrainerMon sParty_Edward[] = {
    ...
    .nature = NATURE_TIMID,
    .moves = {MOVE_PSYBEAM, MOVE_WING_ATTACK, MOVE_SUPERSONIC, MOVE_ATTRACT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 10,
    ...
    .nature = NATURE_TIMID,
    .moves = {MOVE_CONFUSION, MOVE_PSYWAVE, MOVE_ENDEAVOR, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 10,
    ...
    .nature = NATURE_SASSY,
    .moves = {MOVE_FLASH_CANNON, MOVE_EXTRASENSORY, MOVE_MUD_SHOT, MOVE_HYPNOSIS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 10,
    ...
    .moves = {MOVE_CONFUSION, MOVE_FEINT_ATTACK, MOVE_SHOCK_WAVE, MOVE_FAKE_TEARS}
    }
};
...
static const struct TrainerMon sParty_Sidney[] = {
    ...
    .species = SPECIES_CACTURNE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LEECH_SEED, MOVE_FEINT_ATTACK, MOVE_NEEDLE_ARM, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 48,
...
static const struct TrainerMon sParty_Phoebe[] = {
    ...
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_BRICK_BREAK, MOVE_WILL_O_WISP, MOVE_FEINT_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
...
static const struct TrainerMon sParty_Calvin1[] = {
    ...
    .nature = NATURE_HARDY,
    .moves = {MOVE_QUICK_ATTACK, MOVE_FEINT_ATTACK, MOVE_THUNDER_WAVE, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 5,
    ...
    .nature = NATURE_BRAVE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_HEADBUTT, MOVE_SPORE, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 6,
    ...
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_QUICK_ATTACK, MOVE_PECK, MOVE_SAND_ATTACK, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Ben[] = {
    ...
    .nature = NATURE_JOLLY,
    .moves = {MOVE_POISON_FANG, MOVE_AIR_SLASH, MOVE_HYPNOSIS, MOVE_CONFUSE_RAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 15,
    ...
    .nature = NATURE_RELAXED,
    .moves = {MOVE_POISON_FANG, MOVE_LEECH_LIFE, MOVE_PURSUIT, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 13,
    ...
    .nature = NATURE_MILD,
    .moves = {MOVE_SLUDGE, MOVE_BUBBLE_BEAM, MOVE_MUD_SHOT, MOVE_TOXIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 14,
    ...
    .nature = NATURE_DOCILE,
    .moves = {MOVE_SLUDGE, MOVE_FEINT_ATTACK, MOVE_MUD_SHOT, MOVE_SELF_DESTRUCT}
    }
};
...
static const struct TrainerMon sParty_Timmy[] = {
    ...
    .nature = NATURE_BRAVE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_DOUBLE_KICK, MOVE_HOWL, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 8,
    ...
    .nature = NATURE_DOCILE,
    .moves = {MOVE_FLAME_WHEEL, MOVE_METAL_CLAW, MOVE_SWIFT, MOVE_SCARY_FACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 9,
    ...
    .ability = ABILITY_ROCK_HEAD,
    .nature = NATURE_MODEST,
    .moves = {MOVE_WOOD_HAMMER, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 9,
    ...
    .nature = NATURE_HARDY,
    .moves = {MOVE_MUD_SHOT, MOVE_ROCK_THROW, MOVE_SWIFT, MOVE_AGILITY}
    }
};
...
static const struct TrainerMon sParty_Dale[] = {
    ...
    .nature = NATURE_HARDY,
    .moves = {MOVE_WATER_PULSE, MOVE_BITE, MOVE_SECRET_POWER, MOVE_RAIN_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 11,
    ...
    .ability = ABILITY_SWIFT_SWIM,
    .nature = NATURE_MODEST,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_TWISTER, MOVE_SWIFT, MOVE_RAIN_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 11,
    ...
    .ability = ABILITY_HYDRATION,
    .nature = NATURE_CALM,
    .moves = {MOVE_WATER_PULSE, MOVE_ICY_WIND, MOVE_ICE_SHARD, MOVE_REST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 11,
    ...
    .moves = {MOVE_BUBBLE_BEAM, MOVE_ROCK_TOMB, MOVE_BITE, MOVE_RAIN_DANCE}
    }
};
...
static const struct TrainerMon sParty_Edwin1[] = {
    ...
    .ability = ABILITY_OVERGROW,
    .nature = NATURE_TIMID,
    .moves = {MOVE_MEGA_DRAIN, MOVE_SECRET_POWER, MOVE_LIGHT_SCREEN, MOVE_REFLECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 9,
    ...
    .nature = NATURE_MILD,
    .moves = {MOVE_WATER_GUN, MOVE_BITE, MOVE_AERIAL_ACE, MOVE_FLAIL}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 9,
    ...
    .ability = ABILITY_BLAZE,
    .nature = NATURE_HASTY,
    .moves = {MOVE_EMBER, MOVE_MUD_SLAP, MOVE_HEADBUTT, MOVE_QUICK_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 8,
    ...
    .ability = ABILITY_RUN_AWAY,
    .nature = NATURE_IMPISH,
    .moves = {MOVE_QUICK_ATTACK, MOVE_SLEEP_TALK, MOVE_CURSE, MOVE_REST}
    }
};
...
static const struct TrainerMon sParty_Tiana[] = {
    ...
    .nature = NATURE_NAIVE,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_SWIFT, MOVE_THUNDER_WAVE, MOVE_CHARM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 7,
    ...
    .ability = ABILITY_SWIFT_SWIM,
    .nature = NATURE_HASTY,
    .moves = {MOVE_POWDER_SNOW, MOVE_WATER_PULSE, MOVE_SCRATCH, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 7,
    ...
    .moves = {MOVE_ICE_SHARD, MOVE_MUD_SLAP, MOVE_ROCK_THROW, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Rick[] = {
    ...
    .nature = NATURE_MILD,
    .moves = {MOVE_LEECH_LIFE, MOVE_THUNDER_SHOCK, MOVE_POISON_POWDER, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 6,
    ...
    .ability = ABILITY_SWARM,
    .nature = NATURE_NAUGHTY,
    .moves = {MOVE_LEECH_LIFE, MOVE_MEGA_DRAIN, MOVE_STRING_SHOT, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 6,
    ...
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_LEECH_LIFE, MOVE_POISON_STING, MOVE_NIGHT_SHADE, MOVE_SPIDER_WEB}
    }
};
...
static const struct TrainerMon sParty_Lucas2[] = {
    ...
    .lvl = 9,
    .species = SPECIES_WAILMER,
    .moves = {MOVE_AURORA_BEAM, MOVE_WATER_GUN, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Vivian[] = {
    ...
    .nature = NATURE_QUIRKY,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_WATER_PULSE, MOVE_GIGA_DRAIN, MOVE_SUPERSONIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 15,
    ...
    .ability = ABILITY_COMPOUND_EYES,
    .nature = NATURE_SASSY,
    .moves = {MOVE_SLUDGE, MOVE_SILVER_WIND, MOVE_PSYBEAM, MOVE_SLEEP_POWDER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 14,
    ...
    .moves = {MOVE_SLUDGE, MOVE_ANCIENT_POWER, MOVE_MEGA_DRAIN, MOVE_RECOVER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 14,
    ...
    .ability = ABILITY_EFFECT_SPORE,
    .nature = NATURE_QUIET,
    .moves = {MOVE_SLUDGE, MOVE_GIGA_DRAIN, MOVE_NIGHT_SHADE, MOVE_SPORE}
    }
};
...
static const struct TrainerMon sParty_Keigo[] = {
    ...
    .lvl = 28,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_SAND_ATTACK, MOVE_DOUBLE_TEAM, MOVE_SILVER_WIND, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMon sParty_Joseph[] = {
    ...
    .nature = NATURE_BRAVE,
    .moves = {MOVE_STOMP, MOVE_BITE, MOVE_LICK, MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 10,
    ...
    .nature = NATURE_SERIOUS,
    .moves = {MOVE_FLAME_WHEEL, MOVE_ROCK_TOMB, MOVE_MUD_SLAP, MOVE_WILL_O_WISP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 10,
    ...
    .ability = ABILITY_INTIMIDATE,
    .nature = NATURE_NAIVE,
    .moves = {MOVE_SPARK, MOVE_BITE, MOVE_DOUBLE_KICK, MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMon sParty_Alyssa[] = {
    ...
    .ability = ABILITY_INNER_FOCUS,
    .nature = NATURE_MODEST,
    .moves = {MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_BITE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 11,
    ...
    .ability = ABILITY_GUTS,
    .nature = NATURE_JOLLY,
    .moves = {MOVE_QUICK_ATTACK, MOVE_WING_ATTACK, MOVE_MUD_SLAP, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 11,
    ...
    .ability = ABILITY_INTIMIDATE,
    .nature = NATURE_SASSY,
    .moves = {MOVE_SAND_TOMB, MOVE_BITE, MOVE_ROCK_TOMB, MOVE_SWAGGER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 10,
    ...
    .ability = ABILITY_TORRENT,
    .nature = NATURE_MODEST,
    .moves = {MOVE_WATER_GUN, MOVE_ICY_WIND, MOVE_BITE, MOVE_YAWN}
    }
};
...
static const struct TrainerMon sParty_Deandre[] = {
    ...
    .ability = ABILITY_STATIC,
    .nature = NATURE_MILD,
    .moves = {MOVE_SHOCK_WAVE, MOVE_BITE, MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 12,
    ...
    .ability = ABILITY_OWN_TEMPO,
    .nature = NATURE_HASTY,
    .moves = {MOVE_FLAME_WHEEL, MOVE_MUD_SHOT, MOVE_STOMP, MOVE_YAWN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 12,
    ...
    .ability = ABILITY_SWIFT_SWIM,
    .nature = NATURE_BASHFUL,
    .moves = {MOVE_WATER_PULSE, MOVE_BODY_SLAM, MOVE_HYPNOSIS, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 12,
    ...
    .ability = ABILITY_GUTS,
    .nature = NATURE_IMPISH,
    .moves = {MOVE_FORCE_PALM, MOVE_ROCK_THROW, MOVE_SECRET_POWER, MOVE_FOCUS_ENERGY}
    }
};
...
static const struct TrainerMon sParty_Wattson3[] = {
    ...
    .species = SPECIES_PIKACHU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_BODY_SLAM, MOVE_RAIN_DANCE, MOVE_SHOCK_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
...
static const struct TrainerMon sParty_Wattson4[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_BODY_SLAM, MOVE_RAIN_DANCE, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 46,
...
static const struct TrainerMon sParty_Juan2[] = {
    ...
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_DOUBLE_TEAM, MOVE_EARTH_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
